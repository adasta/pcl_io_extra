...
#
#
#Modified by Adam Stambler ( 6/15/2012) to add linux and mac support
...
find_path(XERCES_ROOT
        NAMES include/xercesc/dom/DOM.hpp
        PATHS /usr/local/ /usr/
    )
...
if (Xerces_USE_STATIC_LIBS)
    find_library(Xerces_sLIBRARY_DEBUG
...
if(UNIX AND NOT APPLE)
    set(Xerces_LIBRARY_DIR ${XERCES_ROOT}/lib)
    set(Xerces_LIBRARY xerces-c)
    set(Xerces_LIBRARY_DEBUG xerces-c)
    set(Xerces_LIBRARY_RELEASE xerces-c)
endif()
