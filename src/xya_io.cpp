...
int pcl::XYAReader::readHeader(const std::string & file_name, sensor_msgs::PointCloud2 & cloud,
...
int pcl::XYAReader::read(const std::string & file_name, sensor_msgs::PointCloud2 & cloud,
                         Eigen::Vector4f & origin, Eigen::Quaternionf & orientation,
